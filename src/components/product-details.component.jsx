        ...
        <div className="row no-gutters">
          ...
          <div className="col-md-8">
            <div className="card-body">
              ...
              {location.pathname === '/inventory' && <p className="card-text d-flex justify-content-end"> <CartButton onClick = {()=> {dispatch({type: 'REMOVE_PRODUCT', id: product.id}); clearItemFromCart(product)}}> <span className="badge badge-pill badge-danger" ><i className="fa fa-trash" aria-hidden="true"></i></span> </CartButton></p> }
